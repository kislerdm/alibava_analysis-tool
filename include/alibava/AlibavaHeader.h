...
namespace alibava {
	...
	public:
		...
		//! Returns a new instance of AlibavaHeader
		/*! This method returns an new instance of the this processor.  It
		 *  is called by Marlin execution framework and it shouldn't be
		 *  called/used by the final user.
		 *
		 *  @return a new AlibavaHeader.
		 */
		 ...
		 *  is just calling
		 *  AlibavaHeader::firstLoop(LCEvent*) or
		 *  AlibavaHeader::otherLoop(LCEvent*)
		 *
		 ...
		 *  histograms listed in AlibavaHeader::fillHistos()
		 *  there is also a common mode histo described here below:
		 *
		 *  @see AlibavaHeader::fillHistos() for the todos
		 */
		void bookHistos();
